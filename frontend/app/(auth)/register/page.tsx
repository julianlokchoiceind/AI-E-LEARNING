  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          <div className="mx-auto mb-6 w-16 h-16 bg-gradient-to-br from-purple-500 to-blue-600 rounded-full flex items-center justify-center">
        ...
        >
          <p>By creating an account, you join our community of learners dedicated to mastering AI</p>
        </motion.div>
      </motion.div>
    </div>
  )
