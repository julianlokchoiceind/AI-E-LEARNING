...
import { AnimatedButton } from '@/components/ui/modern/ModernComponents'
import { AlertCircle, CheckCircle, Mail, Lock, LogIn, Eye, EyeOff } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          <div className="mx-auto mb-6 w-16 h-16 bg-gradient-to-br from-primary to-primary-dark rounded-full flex items-center justify-center">
          ...
          <div className="px-8 pb-8">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <motion.button
                ...
                disabled={isLoading}
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
        ...
        >
          <p>By signing in, you agree to our <a href="/terms" className="text-primary hover:text-primary-hover">Terms of Service</a> and <a href="/privacy" className="text-primary hover:text-primary-hover">Privacy Policy</a></p>
        </motion.div>
      </motion.div>
    </div>
  )
